...
## Report bugs using Github's [issues](https://github.com/BMTLab/http-status/issues)

We use GitHub issues to track public bugs. Report a bug
by [opening a new issue](https://github.com/BMTLab/http-status/issues/new); it's that easy!
...
Thank you for contributing to the **BMTLab/http-status** project!
